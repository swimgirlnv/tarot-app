...
function ShootingForward(props: any){
  ...
  useEffect(() => {
    if (loaded) {
        axios.get("http://localhost:4567/getCards/5", config)
                // @ts-ignore
                .then(response => {
...
axios.get("http://localhost:4567/getCardName/" + cardIDFive, config)
        // @ts-ignore
        .then(response => {
          console.log("this is response.data for getCard: " + response.data);
...
axios.get("http://localhost:4567/getCardImage/" + cardIDFive, config)
              // @ts-ignore
              .then(response => {
              console.log("this is response.data for getCardImage: " + response.data);
...
axios.get("http://localhost:4567/getCardUpright/" + cardIDFive, config)
              // @ts-ignore
              .then(response => {
              console.log("this is response.data for getCardUpright: " + response.data);
...
axios.get("http://localhost:4567/getCardReverse/" + cardIDFive, config)
              // @ts-ignore
              .then(response => {
              console.log("this is response.data for getCardReverse: " + response.data);
...
axios.get("http://localhost:4567/getReadingShootingForward/" + cardNameOne + "/" + cardNameTwo + "/"
